            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="text-container">
                        <h1 class="h1-large">Apply for Credit & Get Approved within 24hrs</h1>
                        <p class="p-large">Get your credit and prepaid card applications approved as quick as you need them for your convenience</p>
                        <a class="btn-solid-lg" href="{!! url('/apply'); !!}">Apply Now</a>
                        ...
                        <div class="swiper-container image-slider">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <img class="img-fluid" src="images/sbm.png" alt="alternative">
                                </div>
                                <div class="swiper-slide">
                                    <img class="img-fluid" src="images/aakenya.png" alt="alternative">
                                </div>
                                <div class="swiper-slide">
                                    <img class="img-fluid" src="images/sbm.png" alt="alternative">
                                </div>
    ...
    <div id="details" class="basic-2">
        <div class="container">
            <div class="row">
                <div class="col-lg-9">
                    <div class="intro">
                        <h2>Get your bisness running with approved credit to finance your business operations</h2>
            ...
            <div class="row">
                ...
                <div class="col-lg-5">
                    <div class="text-container">
                        ...
                        <!-- <a class="btn-solid-reg popup-with-move-anim" href="#details-lightbox">Apply</a> -->
                    </div> <!-- end of text-container -->
                </div> <!-- end of col -->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="text-container">
                        ...
                        <h2>Attach the Required Files</h2>
